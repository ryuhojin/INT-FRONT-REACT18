...
const StyleWriteViewer = styled.div<{ mode: string }>`
  margin-top: 0.5rem;
  background: #fff;
  padding: 1rem;
  ...
  ${(props) =>
    props.mode === "VIEWER"
      ...
      : css`
        ...
        `}
`;
const filterWhitespace = (node: string) =>
...
const WriteViewer: React.FC<WriteViewerProps> = ({ value, mode }) => (
  <StyleWriteViewer mode={mode}>
